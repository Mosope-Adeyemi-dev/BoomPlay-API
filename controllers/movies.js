...
module.exports = {
    ...
    getTvShowDetails: (req, res) => {
        ...
        if (tvShowID) {
            axios.get(`${baseUrl}/tv/${tvShowID}?api_key=${process.env.TMDB_API_KEY}&language=en-US`, {
                headers: {
                    'content-type': 'application/json'
                }
            }).then(response => {
    ...
    getTvShowRecommendation: (req, res) => {
        const tvShowID = req.query.tvShowID
        axios.get(`${baseUrl}/tv/${tvShowID}/similar?api_key=${process.env.TMDB_API_KEY}&language=en-US`, {
            headers: {
                'content-type': 'application/json'
            }
        }).then(response => {
